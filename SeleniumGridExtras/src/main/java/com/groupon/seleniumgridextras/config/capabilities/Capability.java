...
public abstract class Capability extends HashMap {
    ...
    protected void setBrowser(final String browser) {
    ...
    public static Capability getCapabilityFor(final String browserName, final Map capabilityMap) {
    ...
    public static Capability getCapabilityFor(final String browserName) {
